...
import 'luces_l_e_d_model.dart';
export 'luces_l_e_d_model.dart';

class LucesLEDWidget extends StatefulWidget {
  const LucesLEDWidget({super.key});

  @override
  State<LucesLEDWidget> createState() => _LucesLEDWidgetState();
}

class _LucesLEDWidgetState extends State<LucesLEDWidget> {
  late LucesLEDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LucesLEDModel());
  }
                                          ...
                                          child: Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              listViewItemsRecord.description,
