...
import 'productoplacas_model.dart';
export 'productoplacas_model.dart';

class ProductoplacasWidget extends StatefulWidget {
  const ProductoplacasWidget({
    super.key,
    required this.itemParametro,
  });

  final ItemplacasRecord? itemParametro;

  @override
  State<ProductoplacasWidget> createState() => _ProductoplacasWidgetState();
}

class _ProductoplacasWidgetState extends State<ProductoplacasWidget>
    with TickerProviderStateMixin {
  late ProductoplacasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductoplacasModel());
  }
