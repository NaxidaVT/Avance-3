                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1563969105369-e51a28fdd2c3?w=500&h=500',
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1508004526072-3be43a5005f6?w=500&h=500',
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          'https://images.unsplash.com/photo-1624818213542-f337c851c6fe?w=500&h=500',
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
                                  ...
                                  Text(
                                    'Pedido realizado el 5 de Mayo, 2024',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily: 'Inter',
